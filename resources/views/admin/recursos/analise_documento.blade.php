...
@else
    {{ Form::open(['url' => route('admin.candidatos.analise'), 'method' => 'post']) }}
@endif
    ...
    @if (isset($rec))
        <div class="col-md-12">
            <div class="form-group {{ $errors->has('recurso') ? ' has-error' : '' }}">
                ...
                @else
                    <textarea name="recurso" id="recurso" rows="8" class="form-control"></textarea>
                @endif
        ...
        <div class="col-md-12">
            <div class="form-group {{ $errors->has('resposta_socio') ? ' has-error' : '' }}">
                ...
                <textarea name="resposta_socio" id="resposta_socio" rows="8" class="form-control" required @if ($recurso->status_socio == '2') readonly @endif></textarea>                
    ...
    @if (isset($rec))
        ...
        <div class="col-md-12">
            <div class="form-group {{ $errors->has('resposta_res') ? ' has-error' : '' }}">
                ...
                <textarea name="resposta_res" id="resposta_res" rows="8" class="form-control" required @if ($recurso->status_res == '2') readonly @endif></textarea>
